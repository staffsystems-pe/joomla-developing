...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_schemas` VALUES ('700', '3.2.2-2014-01-23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_update_sites` VALUES ('1', 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', '1', '0', ''), ('2', 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', '1', '0', ''), ('3', 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', '1', '0', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_users` VALUES ('127', 'Super User', 'admin', 'miguel@staffsystems.pe', '$P$DLWbphdNWkLwu8eC9h7AFTWe56hlzE.', '0', '1', '2014-03-02 06:14:35', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', '0', '', '');
COMMIT;
...
-- ----------------------------
ALTER TABLE `tbl_assets` AUTO_INCREMENT=54;
...
-- ----------------------------
ALTER TABLE `tbl_extensions` AUTO_INCREMENT=10000;
...
-- ----------------------------
ALTER TABLE `tbl_menu` AUTO_INCREMENT=102;
...
-- ----------------------------
ALTER TABLE `tbl_updates` AUTO_INCREMENT=1;
